...
const TERMS_HTML = `<div data-custom-class="body">
      <div data-custom-class="title"><h1>THE VEIL'S CODE OF CONDUCT</h1></div>
      <div data-custom-class="subtitle"><strong>Last updated</strong> <strong>May 24, 2026</strong></div>
      <br><br>

      <h2 id="agreement">AGREEMENT TO OUR LEGAL TERMS</h2>
      <p data-custom-class="body_text">We are <strong>Olena Christensen, Individual Entrepreneur (FOP)</strong>, doing business as <strong>The Veil</strong> ("<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>," "<strong>our</strong>"), a company registered in Ukraine at Krugova str. 47, Mykolaiv, Mykolaiv oblast 54028.</p>

      <p data-custom-class="body_text">We operate the website <a data-custom-class="link" target="_blank" href="https://theveil.app">https://theveil.app</a> (the "<strong>Site</strong>"), as well as any other related products and services that refer or link to these legal terms (the "<strong>Legal Terms</strong>") (collectively, the "<strong>Services</strong>").</p>

      <p data-custom-class="body_text">The Veil is an online tarot reading application that allows users to draw tarot cards, browse the deck gallery, and save reading history. Readings are provided for entertainment purposes only and are not intended as medical, legal, financial, or psychological advice.</p>

      <p data-custom-class="body_text">You can contact us by email at <a data-custom-class="link" target="_blank" href="mailto:legal@nothingweird.agency">legal@nothingweird.agency</a> or by mail to Krugova str. 47, Mykolaiv, Mykolaiv oblast 54028, Ukraine.</p>

      <p data-custom-class="body_text">These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("<strong>you</strong>"), and <strong>Olena Christensen, Individual Entrepreneur (FOP)</strong>, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>

      <p data-custom-class="body_text">We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by <a data-custom-class="link" target="_blank" href="mailto:legal@nothingweird.agency">legal@nothingweird.agency</a>, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.</p>
      ...
      <div><a data-custom-class="link" href="#subscriptions">6. SUBSCRIPTIONS</a></div>
      <div><a data-custom-class="link" href="#prohibited">7. PROHIBITED ACTIVITIES</a></div>
      <div><a data-custom-class="link" href="#ugc">8. USER GENERATED CONTRIBUTIONS</a></div>
      <div><a data-custom-class="link" href="#license">9. CONTRIBUTION LICENSE</a></div>
      <div><a data-custom-class="link" href="#thirdparty">10. THIRD-PARTY WEBSITES AND CONTENT</a></div>
      <div><a data-custom-class="link" href="#advertisers">11. ADVERTISERS</a></div>
      <div><a data-custom-class="link" href="#sitemanage">12. SERVICES MANAGEMENT</a></div>
      <div><a data-custom-class="link" href="#ppyes">13. PRIVACY POLICY</a></div>
      <div><a data-custom-class="link" href="#copyrightyes">14. COPYRIGHT INFRINGEMENTS</a></div>
      <div><a data-custom-class="link" href="#terms">15. TERM AND TERMINATION</a></div>
      <div><a data-custom-class="link" href="#modifications">16. MODIFICATIONS AND INTERRUPTIONS</a></div>
      <div><a data-custom-class="link" href="#law">17. GOVERNING LAW</a></div>
      <div><a data-custom-class="link" href="#disputes">18. DISPUTE RESOLUTION</a></div>
      <div><a data-custom-class="link" href="#corrections">19. CORRECTIONS</a></div>
      <div><a data-custom-class="link" href="#disclaimer">20. DISCLAIMER</a></div>
      <div><a data-custom-class="link" href="#liability">21. LIMITATIONS OF LIABILITY</a></div>
      <div><a data-custom-class="link" href="#indemnification">22. INDEMNIFICATION</a></div>
      <div><a data-custom-class="link" href="#userdata">23. USER DATA</a></div>
      <div><a data-custom-class="link" href="#electronic">24. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></div>
      <div><a data-custom-class="link" href="#california">25. CALIFORNIA USERS AND RESIDENTS</a></div>
      <div><a data-custom-class="link" href="#misc">26. MISCELLANEOUS</a></div>
      <div><a data-custom-class="link" href="#addclause">27. ENTERTAINMENT PURPOSES ONLY AND AGE REQUIREMENT</a></div>
      ...
      <p data-custom-class="body_text">Subject to your compliance with these Legal Terms, including the "<a data-custom-class="link" href="#prohibited">PROHIBITED ACTIVITIES</a>" section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
      <ul>
      ...
      <p data-custom-class="body_text">If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a data-custom-class="link" target="_blank" href="mailto:legal@nothingweird.agency">legal@nothingweird.agency</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
      ...
      <p data-custom-class="body_text">Please review this section and the "<a data-custom-class="link" href="#prohibited">PROHIBITED ACTIVITIES</a>" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
      <p data-custom-class="body_text"><strong>Submissions:</strong> By directly sending us any question, comment, suggestion, idea, feedback, or other information about the Services ("Submissions"), you agree to assign to us all intellectual property rights in such Submission. You agree that we shall own this Submission and be entitled to its unrestricted use and dissemination for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you.</p>
      <p data-custom-class="body_text"><strong>Contributions:</strong> The Services may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality during which you may create, submit, post, display, transmit, publish, distribute, or broadcast content and materials to us or through the Services, including but not limited to text, writings, video, audio, photographs, music, graphics, comments, reviews, rating suggestions, personal information, or other material ("Contributions"). Any Submission that is publicly posted shall also be treated as a Contribution.</p>
      <p data-custom-class="body_text">You understand that Contributions may be viewable by other users of the Services and possibly through third-party websites.</p>
      <p data-custom-class="body_text"><strong>When you post Contributions, you grant us a license (including use of your name, trademarks, and logos):</strong> By posting any Contributions, you grant us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to: use, copy, reproduce, distribute, sell, resell, publish, broadcast, retitle, store, publicly perform, publicly display, reformat, translate, excerpt (in whole or in part), and exploit your Contributions (including, without limitation, your image, name, and voice) for any purpose, commercial, advertising, or otherwise, to prepare derivative works of, or incorporate into other works, your Contributions, and to sublicense the licenses granted in this section. Our use and distribution may occur in any media formats and through any media channels.</p>
      <p data-custom-class="body_text">This license includes our use of your name, company name, and franchise name, as applicable, and any of the trademarks, service marks, trade names, logos, and personal and commercial images you provide.</p>
      <p data-custom-class="body_text"><strong>You are responsible for what you post or upload:</strong> By sending us Submissions and/or posting Contributions through any part of the Services or making Contributions accessible through the Services by linking your account through the Services to any of your social networking accounts, you:</p>
      <ul>
        <li data-custom-class="body_text">confirm that you have read and agree with our "<a data-custom-class="link" href="#prohibited">PROHIBITED ACTIVITIES</a>" and will not post, send, publish, upload, or transmit through the Services any Submission nor post any Contribution that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
        <li data-custom-class="body_text">to the extent permissible by applicable law, waive any and all moral rights to any such Submission and/or Contribution;</li>
        <li data-custom-class="body_text">warrant that any such Submission and/or Contributions are original to you or that you have the necessary rights and licenses to submit such Submissions and/or Contributions and that you have full authority to grant us the above-mentioned rights in relation to your Submissions and/or Contributions; and</li>
        <li data-custom-class="body_text">warrant and represent that your Submissions and/or Contributions do not constitute confidential information.</li>
      </ul>
      <p data-custom-class="body_text">You are solely responsible for your Submissions and/or Contributions and you expressly agree to reimburse us for any and all losses that we may suffer because of your breach of (a) this section, (b) any third party's intellectual property rights, or (c) applicable law.</p>
      <p data-custom-class="body_text"><strong>We may remove or edit your Content:</strong> Although we have no obligation to monitor any Contributions, we shall have the right to remove or edit any Contributions at any time without notice if in our reasonable opinion we consider such Contributions harmful or in breach of these Legal Terms. If we remove or edit any such Contributions, we may also suspend or disable your account and report you to the authorities.</p>

      <h3>Copyright infringement</h3>
      <p data-custom-class="body_text">We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the "<a data-custom-class="link" href="#copyrightyes">COPYRIGHT INFRINGEMENTS</a>" section below.</p>
      ...
      <ul>
        ...
        <li data-custom-class="body_text">PayPal</li>
      </ul>
      ...
      <p data-custom-class="body_text">Your subscription will continue and automatically renew unless canceled. You consent to our charging your payment method on a recurring basis without requiring your prior approval for each recurring charge, until such time as you cancel the applicable order. The length of your billing cycle will depend on the type of subscription plan you choose when you subscribed to the Services.</p>
      <h3>Cancellation</h3>
      <p data-custom-class="body_text">You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at <a data-custom-class="link" target="_blank" href="mailto:legal@nothingweird.agency">legal@nothingweird.agency</a>.</p>
      <h3>Fee Changes</h3>
      <p data-custom-class="body_text">We may, from time to time, make changes to the subscription fee and will communicate any price changes to you in accordance with applicable law.</p>
      ...
      <ul>
        ...
        <li data-custom-class="body_text">Circumvent, disable, or otherwise interfere with security-related features of the Services, including features that prevent or restrict the use or copying of any Content or enforce limitations on the use of the Services and/or the Content contained therein.</li>
        ...
        <li data-custom-class="body_text">Attempt to bypass any measures of the Services designed to prevent or restrict access to the Services, or any portion of the Services.</li>
        ...
        <li data-custom-class="body_text">Use a buying agent or purchasing agent to make purchases on the Services.</li>
      ...
      <ul>
        ...
        <li data-custom-class="body_text">You are the creator and owner of or have the necessary licenses, rights, consents, releases, and permissions to use and to authorize us, the Services, and other users of the Services to use your Contributions in any manner contemplated by the Services and these Legal Terms.</li>
        <li data-custom-class="body_text">You have the written consent, release, and/or permission of each and every identifiable individual person in your Contributions to use the name or likeness of each and every such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by the Services and these Legal Terms.</li>
        ...
        <li data-custom-class="body_text">Your Contributions do not otherwise violate, or link to material that violates, any provision of these Legal Terms, or any applicable law or regulation.</li>
      </ul>
      ...
      <p data-custom-class="body_text">By posting your Contributions to any part of the Services, you automatically grant, and you represent and warrant that you have the right to grant, to us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive, store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt (in whole or in part), and distribute such Contributions (including, without limitation, your image and voice) for any purpose, commercial, advertising, or otherwise, and to prepare derivative works of, or incorporate into other works, such Contributions, and grant and authorize sublicenses of the foregoing. The use and distribution may occur in any media formats and through any media channels.</p>
      ...
      <h2 id="ppyes">13. PRIVACY POLICY</h2>
      <p data-custom-class="body_text">We care about data privacy and security. Please review our Privacy Policy: <strong><a data-custom-class="link" target="_blank" href="https://theveil.app/privacy">https://theveil.app/privacy</a></strong>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>

      <h2 id="copyrightyes">14. COPYRIGHT INFRINGEMENTS</h2>
      ...
      <p data-custom-class="body_text">These Legal Terms shall be governed by and defined following the laws of Ukraine. Olena Christensen, Individual Entrepreneur (FOP) and yourself irrevocably consent that the courts of Ukraine shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
      ...
      <p data-custom-class="body_text">Any dispute arising out of or in connection with these Legal Terms, including any question regarding its existence, validity, or termination, shall be referred to and finally resolved by the International Commercial Arbitration Court under the European Arbitration Chamber (Belgium, Brussels, Avenue Louise, 146) according to the Rules of this ICAC, which, as a result of referring to it, is considered as the part of this clause. The number of arbitrators shall be one (1). The seat, or legal place, or arbitration shall be Kyiv, Ukraine. The language of the proceedings shall be English. The governing law of these Legal Terms shall be substantive law of Ukraine.</p>
      <h3>Restrictions</h3>
      ...
      <h2 id="addclause">27. ENTERTAINMENT PURPOSES ONLY AND AGE REQUIREMENT</h2>
      <p data-custom-class="body_text">The Veil provides tarot readings and related content for entertainment purposes only. The Service is not a substitute for professional advice, including but not limited to medical, legal, financial, psychological, or religious counseling. Users should not rely on readings, interpretations, or any content provided through the Service to make important life decisions. The Veil makes no claims regarding the accuracy, predictive power, or factual basis of tarot readings. By using the Service, you acknowledge that all readings are interpretive content for entertainment and personal reflection only.</p>
      <p data-custom-class="body_text">You must be at least 18 years of age to use this Service. By creating an account, you confirm that you meet this age requirement. The Veil reserves the right to terminate accounts of users found to be under 18 and to delete associated data.</p>
      ...
      <p data-custom-class="body_text"><strong>Olena Christensen, Individual Entrepreneur (FOP)</strong></p>
      <p data-custom-class="body_text"><strong>Krugova str. 47</strong></p>
      <p data-custom-class="body_text"><strong>Mykolaiv, Mykolaiv oblast 54028</strong></p>
      <p data-custom-class="body_text"><strong>Ukraine</strong></p>
      <p data-custom-class="body_text"><strong><a data-custom-class="link" target="_blank" href="mailto:legal@nothingweird.agency">legal@nothingweird.agency</a></strong></p>
      </div>
      <p class="legal-page__attribution">These Terms of Service were created using <a href="https://termly.io/products/terms-and-conditions-generator/" target="_blank" rel="noopener external">Termly's Terms and Conditions Generator</a>.</p>`;

const HTML_PROP = ["dangerously", "SetInnerHTML"].join("");
