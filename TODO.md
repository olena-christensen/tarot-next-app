...
- [x] **Deliverability domain-side VERIFIED 2026-07-02:** SPF/DKIM/DMARC all PASS ("Show original"). Not the spam cause — it was content/reputation (fixed amount + List-Unsubscribe) + new low-volume domain. No DNS changes needed.
